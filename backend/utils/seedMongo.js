...
async function seedMongo() {
  try {
    ...
    // Clear existing sample records to prevent duplicates
    ...
    await Patient.insertMany(enriched);
    console.log(`Successfully seeded ${enriched.length} records into MongoDB!`);
  } catch (err) {
    console.log('MongoDB seed skipped or offline:', err.message);
  } finally {
